...
> **Status:** CVY-000 (repository bootstrap) complete. No protocol logic implemented yet.
...
| No failure is ever staged                               | CI grep-guard bans staged-failure patterns in non-test code; invalid items point at a contract that genuinely reverts             | `.github/workflows/ci.yml`           | CVY-000           | ENFORCED |
