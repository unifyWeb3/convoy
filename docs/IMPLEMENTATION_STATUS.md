...
Overall: **15% (CVY-000, CVY-001, CVY-002 done)** Next milestone: **CVY-003 — Deploy+verify on Base; FIRST REAL BASE TX**
...
| CVY-003   | Deploy+verify on Base; **FIRST REAL BASE TX**               | TODO        | 0   | **next** — BLOCKED on operator credentials; Day-2 deadline already passed |
