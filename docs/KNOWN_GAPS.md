...
| G-18 | **Budget meter is notional, and no balance moves at all.** Gas UNITS are real and measured; the fee in wei is real and computed; the USD price is frozen; and on 84532 KeeperHub **sponsors** the transaction, so the org wallet's balance does not change | budget figures are notional, and the meter is a policy limit rather than a claim on a balance                                                                                   | None needed — **disclose**: "real gas units, real fee in wei, notional USD at a frozen price, sponsored so no balance moves." Measured in DEC-004                                                                                                                  | ACCEPTED  |
